...
COPY public.customerinfo (c_id, c_name, c_age, c_email, c_mobile, eid, data_id) FROM stdin;
110	Musta Karim	35	m_karim@gmail.com	08055089112	102	5
111	Lilian Jaiye	43	i_jaiye@gmail.com	08055185341	100	3
112	Arthur Musa	50	a_musa@gmail.com	0705528813	107	10
...
120	James Job	44	i_job@gmail.com	08059693919	100	8
...
122	6	Operations	Mile 2	11
107	3	Packaging	Ketu	55
\.
...
ALTER TABLE ONLY public.customerinfo
    ADD CONSTRAINT customerinfo_pkey PRIMARY KEY (c_id);
